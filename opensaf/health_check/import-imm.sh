...
immcfg -c SaAmfCompType \
    ...
    -a saAmfCtDefClcCliTimeout=100000000000 \
...
immcfg -c SaAmfSGType \
    ...
    -a saAmfSgtDefSuRestartProb=600000000000 \
    -a saAmfSgtDefSuRestartMax=3 \
    -a saAmfSgtDefCompRestartProb=60000000000 \
    -a saAmfSgtDefCompRestartMax=3 \
    -a saAmfSgtDefAutoAdjustProb=10000000 \
